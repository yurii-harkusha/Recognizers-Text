...
{
    public class UkrainianTimeParserConfiguration : ITimeParserConfiguration
    {
        ...
        public UkrainianTimeParserConfiguration(ICommonDateTimeParserConfiguration config)
        {
            TimeTokenPrefix = "at ";
            AtRegex = UkrainianTimeExtractorConfiguration.AtRegex;
            TimeRegexes = UkrainianTimeExtractorConfiguration.TimeRegexList;
        ...
        public void AdjustByPrefix(string prefix, ref int hour, ref int min, ref bool hasMin)
        {
            ...
            {
                var match = UkrainianTimeExtractorConfiguration.LessThanOneHour.Match(trimedPrefix);
        ...
        public void AdjustBySuffix(string suffix, ref int hour, ref int min, ref bool hasMin, ref bool hasAm, ref bool hasPm)
        {
            ...
            var deltaHour = 0;
            var match = UkrainianTimeExtractorConfiguration.TimeSuffix.Match(trimedSuffix);
