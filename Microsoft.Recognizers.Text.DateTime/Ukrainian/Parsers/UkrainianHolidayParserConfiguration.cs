...
{
    public class UkrainianHolidayParserConfiguration : BaseHolidayParserConfiguration
    {
        public UkrainianHolidayParserConfiguration() : base()
        {
            this.HolidayRegexList = UkrainianHolidayExtractorConfiguration.HolidayRegexList;
